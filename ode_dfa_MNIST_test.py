...
if __name__ == '__main__':
    ...
    loss_func = nn.CrossEntropyLoss(reduction='none').to(device) #nn.MSELoss() # nn.CrossEntropyLoss()
    losses=[]
    #torch.manual_seed(0)
    ...
    for i, (x_batch, y_batch) in enumerate(train_loader):
        ...
        print('Memory Usage:')
        print('Allocated:', round(torch.cuda.memory_allocated(args.gpu)/1024**3,1), 'GB')
        print('Cached:   ', round(torch.cuda.memory_cached(args.gpu)/1024**3,1), 'GB')
